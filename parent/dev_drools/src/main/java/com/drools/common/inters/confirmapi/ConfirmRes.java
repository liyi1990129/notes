...
public class ConfirmRes {
    ...
    public ConfirmResHead head;
    @FieldName(name = "主体信息",type = DroolsConstants.FieldType.OBJECT)
    public ConfirmResBody body;


    @Data
    public static class ConfirmResHead {
        ...
        public ConfirmResHead(){}
        public ConfirmResHead(String code,String message,String transactionNo){
            this.code = code;
    ...
    @Data
    public static class ConfirmResBody {
