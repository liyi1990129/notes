 ...
 * DATE:      2017/7/20
 */
public interface BaseRuleEntityItemInfoMapper extends Mapper<BaseRuleEntityItemInfo> {
    /**
     * Date 2017/7/20
     ...
     * @param id 属性Id
     */
    BaseRuleEntityItemInfo findBaseRuleEntityItemInfoById(@Param("id") Integer id);
}
