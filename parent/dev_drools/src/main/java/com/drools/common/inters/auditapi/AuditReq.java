...
public class AuditReq extends BaseReq {
    ...
    private AuditReq.AuditReqHead head;
    @Valid
    @FieldName(name = "报文主体信息", type = DroolsConstants.FieldType.OBJECT)
    private AuditReq.AuditReqBody body;

    @Data
    public static class AuditReqHead {
        ...
        @FieldName(name = "流水号", type = DroolsConstants.FieldType.BASE, remark = "invokeAudit")
        @IsCode(code = "invokeAudit", message = "接口选择不正确")
        private String visitCode;//接口选择  "invokeAudit"
    ...
    @Data
    public static class AuditReqBody {
        @Valid
        ...
        private List<AuditReq.Doctor> doctorList;
        @Valid
    ...
    public static class PolicyInfo {
        ...
        @NotNull(message = "失效日不能为空")
        @FieldName(name = "失效日", type = DroolsConstants.FieldType.BASE)
        private long lapsfDate;//失效日
        @NotNull(message = "benBillDate不能为空")
        @FieldName(name = "benBillDate", type = DroolsConstants.FieldType.BASE)
        private long benBillDate;//
        @NotBlank(message = "statFund不能为空")
        @FieldName(name = "statFund", type = DroolsConstants.FieldType.BASE)
        private String statFund;//
        @NotBlank(message = "被保人投保年龄不能为空")
        @FieldName(name = "被保人投保年龄", type = DroolsConstants.FieldType.BASE)
        private String anbAtCcd;//被保人投保年龄
        @NotBlank(message = "周年日不能为空")
        @FieldName(name = "周年日", type = DroolsConstants.FieldType.BASE)
        private String crrcd;//周年日
        @NotBlank(message = "EUBB表是否有'01'数据不能为空")
        @FieldName(name = "EUBB表是否有'01'数据", type = DroolsConstants.FieldType.BASE)
        private String isEubb;//EUBB表是否有'01'数据
        @NotBlank(message = "保单有无客户借款信息不能为空")
        @FieldName(name = "保单有无客户借款信息", type = DroolsConstants.FieldType.BASE)
        private String isLoan;//保单有无客户借款信息
        @NotBlank(message = "保单客户领取生存金次数不能为空")
        @FieldName(name = "保单客户领取生存金次数", type = DroolsConstants.FieldType.BASE)
        private String payres;//保单客户领取生存金次数
        @FieldName(name = "批注标记", type = DroolsConstants.FieldType.BASE)
        private String noteFlag;//批注标记
        @FieldName(name = "有无借款标记", type = DroolsConstants.FieldType.BASE)
        private String loanFlag;//有无借款标记
        @FieldName(name = "复效标记", type = DroolsConstants.FieldType.BASE)
        private String reindFlag;//复效标记
        @FieldName(name = "pcsindFlag", type = DroolsConstants.FieldType.BASE)
        private String pcsindFlag;//

        @Valid
        @FieldName(name = "险种信息信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.Plan> planList;

//        @Valid
//        @FieldName(name = "保全信息", type = DroolsConstants.FieldType.COLLECT)
//        private List<AuditReq.Ptrn> ptrnList;
//
//        @Valid
//        @FieldName(name = "保单批注信息", type = DroolsConstants.FieldType.COLLECT)
//        private List<AuditReq.Note> noteList;

        @Valid
        @FieldName(name = "理赔历史赔案信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.HistoryClm> historyClmList;
    }
    ...
    public static class Plan {
        ...
        @NotNull(message = "险种版本生效日期不能为空")
        @FieldName(name = "险种版本生效日期", type = DroolsConstants.FieldType.BASE)
        private long verFromDate;
        @NotNull(message = "险种版本失效日期不能为空")
        @FieldName(name = "险种版本失效日期", type = DroolsConstants.FieldType.BASE)
        private long verToDate;
        @NotBlank(message = "除外责任分组号不能为空")
        @FieldName(name = "除外责任分组号", type = DroolsConstants.FieldType.BASE)
        private String excludeBenefitGroup;
        @NotNull(message = "险种被保人是否为本人不能为空")
        @FieldName(name = "险种被保人是否为本人", type = DroolsConstants.FieldType.BASE)
        private int jobNo;

        @Valid
        @FieldName(name = "除外责任信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.ExcBencode> excBencodeList;
        @Valid
        @FieldName(name = "除外伤病代码信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.ExcIllcode> excIllcodeList;
        @Valid
        @FieldName(name = "除外手术代码信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.ExcSurgery> excSurgeryList;
        @Valid
        @FieldName(name = "除外意外事故代码信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.ExcAcdt> excAcdtList;
        @Valid
        @FieldName(name = "除外意外事故地信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.ExcEventPlace> excEventPlaceList;

        @Valid
        @FieldName(name = "责任信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.Benefit> benefitList;
    ...
    @Data
    public static class ExcBencode {
        @NotBlank(message = "除外责任不能为空")
        @FieldName(name = "除外责任", type = DroolsConstants.FieldType.BASE)
        private String excBencode;//除外责任
    }

    @Data
    public static class ExcIllcode {
        @NotBlank(message = "除外伤病代码不能为空")
        @FieldName(name = "除外伤病代码", type = DroolsConstants.FieldType.BASE)
        private String illcode;//
    }

    @Data
    public static class ExcSurgery {
        @NotBlank(message = "除外手术代码不能为空")
        @FieldName(name = "除外手术代码", type = DroolsConstants.FieldType.BASE)
        private String surgeryCode;//
    }

    @Data
    public static class ExcAcdt {
        @NotBlank(message = "除外意外事故代码不能为空")
        @FieldName(name = "除外意外事故代码", type = DroolsConstants.FieldType.BASE)
        private String acdtCode;//
    }

    @Data
    public static class ExcEventPlace {
        @NotBlank(message = "除外意外事故地不能为空")
        @FieldName(name = "除外意外事故地", type = DroolsConstants.FieldType.BASE)
        private String eventPlace;//
    }

    @Data
    public static class DfmtGroup {
        @NotBlank(message = "伤残分组号不能为空")
        @FieldName(name = "伤残分组号", type = DroolsConstants.FieldType.BASE)
        private String groupNo;//

        @Valid
        @FieldName(name = "分组伤病代码信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.FormulaIllcode> formulaIllcodeList;
    }

    @Data
    public static class FormulaIllcode {
        @NotBlank(message = "伤病代码不能为空")
        @FieldName(name = "伤病代码", type = DroolsConstants.FieldType.BASE)
        private String illcode;//
    }
    ...
    public static class Benefit {
        ...
        @Valid
        @FieldName(name = "新伤残分组信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.DfmtGroup> dfmtGroupList;

        @Valid
        @FieldName(name = "责任伤病代码分组", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.BenefitIllCode> benefitIllCodeList;
    }

    @Data
    public static class BenefitIllCode {
        @NotBlank(message = "责任伤病代码不能为空")
        @FieldName(name = "伤病代码", type = DroolsConstants.FieldType.BASE)
        private String illcode;//
    }
    ...
    public static class Note {
        ...
        private String noteType;//备注类型
        @NotBlank(message = "界面代码不能为空")
        @FieldName(name = "界面代码", type = DroolsConstants.FieldType.BASE)
        private String screen;//界面代码
        @NotBlank(message = "提醒日不能为空")
        @FieldName(name = "提醒日", type = DroolsConstants.FieldType.BASE)
        private String remDte;//提醒日
        @NotBlank(message = "打印标识不能为空")
        @FieldName(name = "打印标识", type = DroolsConstants.FieldType.BASE)
        private String prtFlg;//打印标识
    }
    ...
    public static class Doctor {
        ...
        private List<AuditReq.Surgery> surgeryList;

        @Valid
        @FieldName(name = "伤病代码信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.IllCode> illcodeList;

        @Valid
        @FieldName(name = "收据信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.Receipt> receiptList;
    }
    ...
    public static class HistoryClm {
        @FieldName(name = "理赔业务号", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔业务号不能为空")
        private String clmnum;//理赔业务号
        @FieldName(name = "分公司", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔分公司不能为空")
        private String clmcoy;//分公司
        @FieldName(name = "分支机构", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔分支机构不能为空")
        private String branch;//分支机构
        @FieldName(name = "营销员ID", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔营销员ID不能为空")
        private String agtId;//营销员ID
        @FieldName(name = "受理日期", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔受理日期不能为空")
        private long submitDte;//受理日期
        @FieldName(name = "报备日期", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔报备日期不能为空")
        private long reportDte;//报备日期
        @FieldName(name = "理赔处理日期", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔理赔处理日期不能为空")
        private long proceDate;//理赔处理日期
        @FieldName(name = "事故认定日", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔事故认定日不能为空")
        private long eventDte;//事故认定日
        @FieldName(name = "意外事故日", type = DroolsConstants.FieldType.BASE)
...
//        @NotBlank(message = "除外责任不能为空")
    ...
    public static class HistoryPlan {
        @FieldName(name = "险种代码", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔险种代码不能为空")
        private String crtable;//险种代码
        @FieldName(name = "life", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔life不能为空")
        private String life;//
        @FieldName(name = "jlife", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔jlife不能为空")
        private String jlife;//
        @FieldName(name = "coverage", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔coverage不能为空")
        private String coverage;//
        @FieldName(name = "rider", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔rider不能为空")
        private String rider;//
        @FieldName(name = "险种状态", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔险种状态不能为空")
        private String statCode;//险种状态
        @FieldName(name = "保费状态", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔保费状态不能为空")
        private String pstatCode;//保费状态
        @FieldName(name = "险种分组", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔险种分组不能为空")
        private String compGrp;//险种分组
        @FieldName(name = "事故认定日", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔事故认定日不能为空")
        private long eventDte;//事故认定日
    ...
    public static class HistoryDoctor {
        @FieldName(name = "就医序号", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔就医序号不能为空")
        private int recId;//就医序号
        @FieldName(name = "医院代码", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔医院代码不能为空")
        private String hsCode;//医院代码
        @FieldName(name = "医院类型", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔医院类型不能为空")
        private String trecTyp;//医院类型
        @FieldName(name = "医院有效标记", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔医院有效标记不能为空")
        private String validFlag;//医院有效标记
        @FieldName(name = "医院等级", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔医院等级不能为空")
        private String hclass;//医院等级
        @FieldName(name = "赔付范围", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔赔付范围不能为空")
        private String sumind;//赔付范围
        @FieldName(name = "医院品质", type = DroolsConstants.FieldType.BASE)
        @NotBlank(message = "历史理赔医院品质不能为空")
        private String hqind;//医院品质
        @FieldName(name = "就医日期", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔就医日期不能为空")
        private int consultDte;//就医日期
        @FieldName(name = "一般病房住院日期", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔一般病房住院日期不能为空")
        private int hsDte;//一般病房住院日期
        @FieldName(name = "一般病房出院日期", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔一般病房出院日期不能为空")
        private int leaveDte;//一般病房出院日期
        @FieldName(name = "一般病房住院天数", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔一般病房住院天数不能为空")
        private int hsDays;//一般病房住院天数
        @FieldName(name = "加护病房住院日期", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔加护病房住院日期不能为空")
        private int icuHsDte;//加护病房住院日期
        @FieldName(name = "加护病房出院日", type = DroolsConstants.FieldType.BASE)
        @NotNull(message = "历史理赔加护病房出院日不能为空")
        ...
        private List<AuditReq.HistoryIllcode> historyIllcodeList;

        @Valid
        @FieldName(name = "历史赔案手术信息", type = DroolsConstants.FieldType.COLLECT)
        private List<AuditReq.HistorySurgery> historySurgeryList;
    }
